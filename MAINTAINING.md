...
We have a [template repo](https://github.com/micronaut-projects/micronaut-age) that we use as the single
...
[Release GitHub Action workflow](https://github.com/micronaut-projects/micronaut-age/blob/master/.github/workflows/release.yml)
