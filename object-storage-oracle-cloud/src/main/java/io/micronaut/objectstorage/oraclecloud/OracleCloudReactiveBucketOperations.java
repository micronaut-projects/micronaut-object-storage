...
public class OracleCloudReactiveBucketOperations extends DefaultReactiveBucketOperations<GetBucketResponse> {

    public OracleCloudReactiveBucketOperations(OracleCloudBucketOperations operations,
