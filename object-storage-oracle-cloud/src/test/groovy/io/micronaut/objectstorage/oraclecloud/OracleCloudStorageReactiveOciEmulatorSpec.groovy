...
class OracleCloudStorageReactiveOciEmulatorSpec extends AbstractOracleCloudStorageReactiveSpec {

    public static final String SPEC_NAME = 'OracleCloudStorageReactiveOciEmulatorSpec'
