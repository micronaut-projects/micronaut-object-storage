...
/**
 * Reactive AWS S3 object storage operations.
 *
 * @author Cliponaut
 * @since 3.1.0
 */
@EachBean(AwsS3Configuration.class)
@Requires(beans = AwsS3Operations.class)
@Requires(beans = AwsS3Configuration.class)
public class AwsS3ReactiveOperations extends DefaultReactiveObjectStorageOperations<
