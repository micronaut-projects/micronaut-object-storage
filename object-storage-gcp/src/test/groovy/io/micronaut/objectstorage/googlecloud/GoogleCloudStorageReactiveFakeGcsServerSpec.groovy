...
class GoogleCloudStorageReactiveFakeGcsServerSpec extends AbstractGoogleCloudStorageReactiveSpec {

    public static final String TEST_PROJECT_ID = 'test-project'
    public static final String SPEC_NAME = 'GoogleCloudStorageReactiveFakeGcsServerSpec'
